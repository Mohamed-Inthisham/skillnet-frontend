...
const ContactInfo = () => {
  return (
    <div className="bg-gray-100 p-6 rounded-lg flex flex-col md:flex-row justify-between items-center ">
      <div className="md:w-2/3">
        <h2 className="text-lg font-semibold text-blue-400 -mt-2">Get in Touch</h2>
        <p className="text-gray-600 mt-6 tracking-wider">
          Have questions or need assistance? We're here to help! Reach <br/> out via
          phone or email, and we'll respond as soon as possible.
        </p>
      </div>
      <div className="md:w-1/4 flex flex-col gap-3 mt-4 md:mt-0">
        <div className="flex items-center gap-3">
          <span className="bg-blue-400 p-2 rounded-full"><img src={email}/></span>
          <span className="text-gray-700">admin@aigl.com</span>
        </div>
        <div className="flex items-center gap-3">
          <span className="bg-blue-400 p-2 rounded-full"><img src={whatsapp}/></span>
